...
const gcpSpendAggregationRoute = require("./routes/spend-aggregation/gcp/aggregation");
...
app.use(`${AWS_API_ENDPOINT}/aggregation`, aggregatorRoute);
...
app.use(`${GCP_API_ENDPOINT}/aggregation`, gcpSpendAggregationRoute);

mongoose
	.connect("mongodb+srv://costgovernanceserviceuser:Ajith%401996@cost-governance-service.j0ncg.gcp.mongodb.net/cgsdb?retryWrites=true&w=majority", {
